...
int main()
{
	...
	std::string userText = pIn->GetSrting(pOut, "Enter a string:", "");
	pOut->ClearStatusBar();                           // remove the prompt
	// Draw the entered string inside the drawing area (adjust coordinates as needed)
	pOut->DrawString(150, 150, userText);
	pOut->PrintMsg("String drawn in drawing area. Click anywhere to continue");
